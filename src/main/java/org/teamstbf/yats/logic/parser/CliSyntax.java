...
public class CliSyntax {
    ...
    /* Prefix definitions */
    //should be redundant prefixes for editCommand
    ...
    public static final Prefix PREFIX_ADD_TIME = new Prefix(",");
    public static final Prefix PREFIX_ADD_LOCATION = new Prefix("@");
    public static final Prefix PREFIX_ADD_TAG = new Prefix("#");
    public static final Prefix PREFIX_ADD_DESCRIPTION = new Prefix("//");
