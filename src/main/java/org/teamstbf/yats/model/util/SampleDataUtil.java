		...
		try {
			return new Event[] {
					new Event(new Title("Vascular Medicine Research"),
							...
							new Periodic("none"),
							new Schedule(org.teamstbf.yats.logic.parser.ParserUtil.parseSingleDate("6:00pm")),
							new Schedule(org.teamstbf.yats.logic.parser.ParserUtil.parseSingleDate("8:00pm")),
					...
					new Event(new Title("Grocery Shopping"),
							...
							new Schedule(org.teamstbf.yats.logic.parser.ParserUtil.parseSingleDate("10:00pm")),
							new Schedule(org.teamstbf.yats.logic.parser.ParserUtil.parseSingleDate("2:00pm")),
							new Description("Buy some food"),
							new UniqueTagList("necessitires")),
					new Event(new Title("Vscan Access Mid Term"),
							new Location("School"),
							new Periodic("daily"),
							new Schedule(org.teamstbf.yats.logic.parser.ParserUtil.parseSingleDate("2:30pm")),
							new Schedule(org.teamstbf.yats.logic.parser.ParserUtil.parseSingleDate("2:30pm")),
					...
					new Event(new Title("Project Milestone Documentation"),
							new Location("School"),
							new Periodic("weekly"),
							new Schedule(org.teamstbf.yats.logic.parser.ParserUtil.parseSingleDate("4:00pm")),
							new Schedule(org.teamstbf.yats.logic.parser.ParserUtil.parseSingleDate("5:00pm")),
